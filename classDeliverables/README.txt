...
-----------------------------------------------------------
ftp_client.py
This file implements an FTP client. This client file is in charge of prompting the user for a command and then executing code based on the command. The commands are as follows:
